...
contract MyToken is ERC20Interface {
    ...
    string constant public name = "ks2377"; // TODO CHANGE THIS!
    ...
    function withdraw(uint256 _num_tokens) public virtual override returns (bool success) {
        ...
        if (_num_tokens <= _accountBalances[msg.sender]){
            uint wei_transfer = _num_tokens * 1000;
            _accountBalances[msg.sender] = _accountBalances[msg.sender] - _num_tokens;
            _totalSupply = _totalSupply - _num_tokens;

            msg.sender.transfer(wei_transfer);
